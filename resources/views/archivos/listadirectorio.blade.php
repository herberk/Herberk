...
<div class="d-flex justify-content-between align-items-end">
    ...
    <p>
        @if ($view == 'index')
        <a href="{{ route('fileexcel') }}" class="btn btn-sm  btn-outline-success"><i class="fas fa-file-excel"></i> Exportar Xls </a>

        <a href="{{ route('filescreate') }}" class="btn btn-dark" >Nuevo Directorio</a>
        @else
