<table class="table table-sm table-bordered table-striped" id="dataTable">
    ...
    <tr data-id="<?php echo e($categori->id); ?>">
        ...
        <td><?php echo e($categori->ano.' '.$categori->name); ?></td>

        <td style="width: 100px;text-align: right">
            <?php if($view == 'index'): ?>
                <?php $__env->startComponent('shared._tooltip'); ?>
                <?php $__env->slot('mensa', 'Edita Directorio'); ?>
                <a href="<?php echo e(route('fileedit',$categori)); ?>" class="btn btn-outline-success btn-sm"><i class="fas fa-pencil-alt"></i></a>
                <?php echo $__env->renderComponent(); ?>
                <?php $__env->startComponent('shared._tooltip'); ?>
                <?php $__env->slot('mensa', 'Elimina Directorio '); ?>
                <a href="<?php echo e(route('file/destroy', [$categori->id])); ?>" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash fa-sm"></i></a>
                <?php echo $__env->renderComponent(); ?>
             <?php endif; ?>
        </td>
