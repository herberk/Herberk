    ...
    <?php $__env->startSection('content'); ?>
        <div class="container">
            ...
            <?php echo Form::model($empresas, ['route' => ['empresa/updatenota', $empresas], 'method' => 'PUT','class'=>"form-horizontal"]); ?>
               ...
               <?php echo $__env->make('empresas.partials.NoteModal', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo Form::close(); ?>
     ...
     <?php $__env->startSection('content'); ?>
        <div class="container">
            ...
            <?php echo Form::model($empresas, ['route' => ['logo', $empresas], 'method' => 'POST','enctype' =>"multipart/form-data",'class'=>"form-horizontal"]); ?>
                ...
                <?php echo $__env->make('empresas.partials._logoModal', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo Form::close(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <?php echo $__env->make('empresas.partials._selecjurada', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo Form::close(); ?>
